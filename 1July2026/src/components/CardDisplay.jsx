...
import { TrendUp, TrendDown, ShoppingCart, Heart } from 'phosphor-react';
import { isInVault, addToVault, removeFromVault } from '../services/vault';
import { useToast } from '../context/ToastContext';
import { useAuth } from '../context/AuthContext';

const CardDisplay = ({ id, name, image, price, trend, rarity, affiliateLink }) => {
  const isUp = trend >= 0;
          ...
          <div className="flex-between" style={{ alignItems: 'flex-end' }}>
            ...
            <div style={{
              ...
              <span className="flex-center" style={{
                ...
                {isUp ? <TrendUp weight="bold" size={16} /> : <TrendDown weight="bold" size={16} />}
                {Math.abs(trend)}%
              </span>
            </div>
          </div>
