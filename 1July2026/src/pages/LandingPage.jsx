...
const LandingPage = () => {
  ...
  return (
    <div style={{ background: 'var(--bg-primary)' }}>
      <style>{`
        /* Mobile-specific overrides for landing page */
      ...
      <section className="hero-section" style={{
        ...
        <div className="container" style={{ maxWidth: '1000px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{
            ...
            {t('home.hero.headline')} <span className="text-accent">{t('home.hero.headlineAccent')}</span> {t('home.hero.headlineEnd')}
          </h1>
      ...
      <section className="container" style={{ padding: '80px 24px', maxWidth: '1100px' }}>
        ...
        <div className="flex-between" style={{ marginBottom: '48px', flexWrap: 'wrap', gap: '16px' }}>
          <div>
            <h2 style={{ marginBottom: '12px', fontSize: '2.75rem' }}>
      ...
      <section style={{
        ...
        <div className="container" style={{ maxWidth: '1200px' }}>
          <div style={{ textAlign: 'center', marginBottom: '80px' }}>
            <h2 style={{ marginBottom: '20px', fontSize: '2.75rem' }}>
      ...
      <section id="pricing" className="container" style={{ padding: '100px 24px', maxWidth: '1200px' }}>
        ...
        <div className="flex-center" style={{ gap: '40px', flexWrap: 'wrap', alignItems: 'stretch' }}>
          {/* Free Tier */}
          <div className="glass-panel" style={{
            padding: '48px',
            flex: '1 1 360px',
      ...
      <section style={{
        ...
        <div className="container" style={{ maxWidth: '800px' }}>
          <h2 style={{ color: 'white', marginBottom: '20px', fontSize: '3rem' }}>
            {t('home.cta.title')}
          </h2>
          <p style={{
