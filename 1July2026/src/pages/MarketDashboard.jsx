        ...
        <div className="glass-panel" style={{
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              {['Secret Rare', 'Ultra Rare', 'Rare', 'Uncommon'].map((rarity) => (
                <label key={rarity} className="flex-center" style={{
                  justifyContent: 'flex-start',
                  gap: '10px',
                  cursor: 'pointer',
                  transition: 'all 0.2s',
                ...
                onMouseOut={e => e.currentTarget.style.background = 'transparent'}>
                  <input type="checkbox" defaultChecked={rarity === 'Secret Rare' || rarity === 'Ultra Rare'} style={{ accentColor: 'var(--accent-terracotta)', width: '18px', height: '18px', cursor: 'pointer' }} />
                  {rarity}
                </label>
              ))}
            </div>
        ...
        <div style={{
          ...
          {loading ? (
            ...
            <div style={{
              ...
              <p style={{ fontSize: '1.05rem' }}>Try adjusting your search or filters</p>
            </div>
          )}
        </div>
      </div>
